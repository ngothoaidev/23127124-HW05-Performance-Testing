...
These items cannot be fabricated or completed silently by AI.
...
- [ ] Capture Task Manager/JMeter screenshots for Load, Stress, and Spike in the same frame.
- [ ] Run `dxdiag` and capture a screenshot showing hostname `THOAI`.
...
- [ ] Publish the two verified issue drafts with screenshots and add their URLs.
